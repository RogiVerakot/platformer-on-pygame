...
player = Player()
grasscliffmid = GrassCliffMid()
grasscliffmid_2 = GrassCliffMid_2()
grasscliffmid_3 = GrassCliffMid_3()
grasscliffmid_4 = GrassCliffMid_4()
grasscliffmid_5 = GrassCliffMid_5()
grasscliffmid_6 = GrassCliffMid_6()
...
while running:
    ...
    # screen.fill("black")
    screen.blit(image, (0, 0))  # Рисуем картинку в координатах (100, 100)
    # all_sprites.draw(screen)
    screen.blit(grasscliffmid.image, grasscliffmid.rect)
    screen.blit(grasscliffmid_2.image, grasscliffmid_2.rect)
    screen.blit(grasscliffmid_3.image, grasscliffmid_3.rect)
    ...
    screen.blit(grasscliffright.image, grasscliffright.rect)

    screen.blit(grasscliffleft.image, grasscliffleft.rect)
    # wave.draw(screen)
