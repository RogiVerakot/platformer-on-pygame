...
player = Player()
grassmid = GrassMid(356, 1212)
grassmid_2 = GrassMid(456, 1212)
grassmid_3 = GrassMid(556, 1212)
grass856x1112 = Grass(856, 1112)
grass1056x1012 = Grass(1056, 1012)
grass856x912 = Grass(856, 912)
grass656x812 = Grass(656, 812)
grass456x712 = Grass(456, 712)

grassright = GrassRight(656, 1212)
